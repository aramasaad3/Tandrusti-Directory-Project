  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final category = _field('category', 'Medicine');
        final translatedCategory = LocalizationService.translate(category, lang);
        
        final uses = _field('usageInstructions', 'No usage data');
        final dosage = _field('dosage', 'Refer to doctor');
        final sideEffects = _field('sideEffects', 'None recorded');
        final contraindications = _field('contraindications', 'None recorded');
